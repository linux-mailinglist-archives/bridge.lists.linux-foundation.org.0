...
Received: from whitealder.osuosl.org (smtp1.osuosl.org [140.211.166.138])
	by mail.lfdr.de (Postfix) with ESMTPS id 714FF28F19A
	for <lists.bridge@lfdr.de>; Thu, 15 Oct 2020 13:56:30 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by whitealder.osuosl.org (Postfix) with ESMTP id 24E1C8867B;
	Thu, 15 Oct 2020 11:56:29 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from whitealder.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id ChA4OxYyGVg4; Thu, 15 Oct 2020 11:56:27 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by whitealder.osuosl.org (Postfix) with ESMTP id 48DC988440;
	Thu, 15 Oct 2020 11:56:27 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 2F459C0051;
	Thu, 15 Oct 2020 11:56:27 +0000 (UTC)
X-Original-To: bridge@lists.linux-foundation.org
Delivered-To: bridge@lists.linuxfoundation.org
Received: from fraxinus.osuosl.org (smtp4.osuosl.org [140.211.166.137])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 54A81C0051
 for <bridge@lists.linux-foundation.org>; Thu, 15 Oct 2020 11:56:26 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by fraxinus.osuosl.org (Postfix) with ESMTP id 42E7E88361
 for <bridge@lists.linux-foundation.org>; Thu, 15 Oct 2020 11:56:26 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from fraxinus.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id navOCYkVrwm9 for <bridge@lists.linux-foundation.org>;
 Thu, 15 Oct 2020 11:56:24 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from esa2.microchip.iphmx.com (esa2.microchip.iphmx.com
 [68.232.149.84])
 by fraxinus.osuosl.org (Postfix) with ESMTPS id 4A9A4883B6
 for <bridge@lists.linux-foundation.org>; Thu, 15 Oct 2020 11:56:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
 d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
 t=1602762984; x=1634298984;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=JpNhmDhlfKplqbvU64U2TuFt+f8oMiYzv+3aSWNOvrM=;
 b=VdWvU/DheD+N7F0FNBv9k/n+ZXBVw8em5ISTaZx5UsZxyZNpDKBfSMa/
 tPP7d8ex/2Qlemfs3CefetMiuiT7Ia4YV1QOr72oH+chzfw3+BIeYVCUq
 aRUSb6abPRcqVo/XYGgBz67pzoxZ/cab0G10B4kHhPM51ckPlo603bQ0x
 pY3J6U37bo5N6hcmc5w8RPnx6IVx+Uq7Z2SZTwYdVwBKJ64YUyVcz3KAb
 ZKDLLu6jneEPaxSm2Y0iWoTew6c2MnSGv1iW6j0hog1lFVz5LL+8uXJWA
 55X8RF/rmWEa6ER5IdADMCwSPjOW6bRcaYFWAFj3Ra1ttRDGUlc5lbRU4 w==;
IronPort-SDR: 
X-IronPort-AV: E=Sophos;i="5.77,378,1596524400"; d="scan'208";a="92709655"
Received: from smtpout.microchip.com (HELO email.microchip.com)
 ([198.175.253.82])
 by esa2.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256;
 15 Oct 2020 04:56:23 -0700
Received: from chn-vm-ex03.mchp-main.com (10.10.85.151) by
 chn-vm-ex03.mchp-main.com (10.10.85.151) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1979.3; Thu, 15 Oct 2020 04:56:23 -0700
Received: from soft-test08.microsemi.net (10.10.115.15) by
 chn-vm-ex03.mchp-main.com (10.10.85.151) with Microsoft SMTP Server id
 15.1.1979.3 via Frontend Transport; Thu, 15 Oct 2020 04:56:21 -0700
To: <davem@davemloft.net>, <kuba@kernel.org>, <roopa@nvidia.com>,
 <nikolay@nvidia.com>, <jiri@mellanox.com>, <idosch@mellanox.com>,
 <linux-kernel@vger.kernel.org>, <netdev@vger.kernel.org>,
 <bridge@lists.linux-foundation.org>, <UNGLinuxDriver@microchip.com>
Date: Thu, 15 Oct 2020 11:54:15 +0000
Message-ID: <20201015115418.2711454-8-henrik.bjoernlund@microchip.com>
...
Subject: [Bridge] [PATCH net-next v6 07/10] bridge: cfm: Netlink SET
...
---
 ...
 net/bridge/br_cfm.c            |  23 +-
 net/bridge/br_cfm_netlink.c    | 456 +++++++++++++++++++++++++++++++++
...
index d63b705feb48..3912fedfd289 100644
--- a/net/bridge/br_cfm.c
+++ b/net/bridge/br_cfm.c
@@ -602,18 +602,6 @@ int br_cfm_mep_config_set(struct net_bridge *br,
...
-
 	...
 	if (!mep) {
 		NL_SET_ERR_MSG_MOD(extack,
@@ -679,12 +667,6 @@ int br_cfm_cc_peer_mep_add(struct net_bridge *br, const u32 instance,
...
-	}
 	...
 	if (peer_mep) {
@@ -817,6 +799,11 @@ int br_cfm_cc_ccm_tx(struct net_bridge *br, const u32 instance,
 	return 0;
 }
...
index 000000000000..8a7545ab0014
--- /dev/null
...
+	[IFLA_BRIDGE_CFM_MEP_CONFIG_MEPID]	 = {
+	.type = NLA_U32, .validation_type = NLA_VALIDATE_MAX, .max = 0x1FFF },
+};
+
+static const struct nla_policy
