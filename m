...
Received: from mail.linuxfoundation.org (mail.linuxfoundation.org [140.211.169.12])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A0F130D55
	for <lists.bridge@lfdr.de>; Fri, 31 May 2019 13:30:16 +0200 (CEST)
Received: from mail.linux-foundation.org (localhost [127.0.0.1])
	by mail.linuxfoundation.org (Postfix) with ESMTP id F344F1029;
	Fri, 31 May 2019 11:29:49 +0000 (UTC)
X-Original-To: bridge@lists.linux-foundation.org
Delivered-To: bridge@mail.linuxfoundation.org
Received: from smtp1.linuxfoundation.org (smtp1.linux-foundation.org
	[172.17.192.35])
	by mail.linuxfoundation.org (Postfix) with ESMTPS id 431091011
	for <bridge@lists.linux-foundation.org>;
	Fri, 31 May 2019 11:28:56 +0000 (UTC)
X-Greylist: whitelisted by SQLgrey-1.7.6
Received: from mail-io1-f65.google.com (mail-io1-f65.google.com
	[209.85.166.65])
	by smtp1.linuxfoundation.org (Postfix) with ESMTPS id 7E3BC81A
	for <bridge@lists.linux-foundation.org>;
	Fri, 31 May 2019 11:28:55 +0000 (UTC)
Received: by mail-io1-f65.google.com with SMTP id k8so7881574iot.1
	for <bridge@lists.linux-foundation.org>;
	Fri, 31 May 2019 04:28:55 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=20161025;
	h=mime-version:references:in-reply-to:from:date:message-id:subject:to
	:cc; bh=X18idEV00OtQ11TyxgLtNbF7xc5UhiD1wmkoD1b0+zA=;
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
	...
	b=
X-Gm-Message-State: APjAAAW0LnaH5hgv7b8yNpEeWuYbAmvlc1FGE3HyAwdmb9XEctqtoWni
	1UinrElFuwPl6KbnWRGvuIQL3IbobEGt/O98DuWLpg==
...
MIME-Version: 1.0
References: <00000000000047d84e058089773f@google.com>
	<CACT4Y+aKFM2Gi4mGVCSMZNv_20SAP2KhjnSZYmNr18va_bXv_Q@mail.gmail.com>
...
Cc: Herbert Xu <herbert@gondor.apana.org.au>, netdev <netdev@vger.kernel.org>,
	Roopa Prabhu <roopa@cumulusnetworks.com>,
	bridge@lists.linux-foundation.org,
	syzkaller-bugs <syzkaller-bugs@googlegroups.com>,
	LKML <linux-kernel@vger.kernel.org>,
	Alexander Potapenko <glider@google.com>, David Miller <davem@davemloft.net>
Subject: Re: [Bridge] KMSAN: uninit-value in br_mdb_ip_get
